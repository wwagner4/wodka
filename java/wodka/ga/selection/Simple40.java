...
public class Simple40 implements SelectionPolicy {
    ...
    public Population selectNewPopulation(Population current,
        ...
        for (int i = 0; i < 20; i++) {
            m = current.getIndividual(ran.nextInt(current.size())).copy();
            population.addIndividual(m);
        }
        return population;
    }
    ...
    public String getInfo() {
        ...
        sb
                .append("-20 random individuals are copied from the old population\n");
        return sb.toString();
    }
